...
# -----------------------------
# Load CSV from GitHub if no file is uploaded
# -----------------------------
if uploaded_file is not None:
    df = pd.read_csv(uploaded_file)
else:
    st.info("No CSV uploaded, using CSV from GitHub")
    # Replace the URL below with your GitHub raw CSV link
...
if cat_cols:
    ...
    cat_counts = cat_counts.head(50)  # Limit to top 50 categories
